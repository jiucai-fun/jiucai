...
import fun.jiucai.packet.SimulatorChatAnswer;
import fun.jiucai.packet.SimulatorRegisterAnswer;
import fun.jiucai.packet.SimulatorRegisterAsk;
import fun.jiucai.packet.SimulatorStatusAsk;
